      ...
      <>
        ...
        <div className='min-h-screen font-sans antialiased bg-black'>
          ...
          <div className='relative z-10 flex flex-col items-center justify-center min-h-screen py-10'>
            ...
            {/* the form */}
            <form
              className='flex flex-col items-center w-full max-w-4xl mx-auto mt-8 space-y-2 text-2xl font-light text-white md:space-y-4 md:text-4xl md:w-3/5 md:mt-10'
            ...
            >
              ...
              <div className='flex flex-wrap items-end justify-center space-x-5 space-y-2 md:space-y-4'>
                <span className='flex-shrink-0 inline-block'>My name is</span>
                <input onChange={(event) => setName(event.target.value)} className='w-64 input' type='text' name='name' required />
                <span className='flex-shrink-0 inline-block'>and I drive a</span>
              </div>

              <div className='flex flex-wrap items-end justify-center space-x-5'>
                <input className='w-20 input' type='text' name='vehicle' placeholder='1973' required />
                <select className='w-64 input select' onChange={(event) => setMake(event.target.value)}>
...

                {
                  models
                  ? (
                    <select className='w-48 input select' onChange={(event) => setModel(event.target.value)}>
                      {models.map(model => {
